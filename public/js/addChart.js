...
function addChart(divId, clientId, websocket) {
    ...
    plusButton.addEventListener('click', () => {
      ...
      // Create y-axis dropdown list
        ...
        populateDropdown(yAxisDropdown, ["time","batch","cycle","phase","en","rp","ec","cur","prs_md","prs_pf","vol_di","vol_rg","vol_fw","ec delta","q_charge","ec_int","ec_int2","salts","efficiency"]);
      ...
      goButton.addEventListener('click', () => {
        ...
        else if (selectedXAxisValue === "time" && selectedYAxisValue === "ec_int2") {
          const message = {
            plot: "ec_int2",
            xSelected: selectedXAxisValue,
            ySelected: selectedYAxisValue,
        ...
        else if (selectedXAxisValue === "time" && selectedYAxisValue === "salts") {
          const message = {
            plot: "salts",
            xSelected: selectedXAxisValue,
            ySelected: selectedYAxisValue,
        ...
        else if (selectedXAxisValue === "time" && selectedYAxisValue === "efficiency") {
          const message = {
            plot: "efficiency",
            xSelected: selectedXAxisValue,
            ySelected: selectedYAxisValue,
